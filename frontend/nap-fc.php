...
<main>
    <div class="container">
        <div class="nap-fc-container">
            <h1>FC Online (VN)</h1>
            <div class="alert">
                <p>Nạp FC Online nhận ngay 2 gói ICON THE MOMENT và 1 thẻ BP 100B khi nạp thẻ lần đầu trong ngày với thẻ có mệnh giá từ 500.000đ trở lên.</p>
            ...
            <div class="payment-methods">
                <button class="active">Thẻ Garena</button>
            ...
            <div class="card-details">
                ...
                <div class="points-list">
                    ...
                    <ul>
                        ...
                        <li>FC x 408 (+ 408)</li>
                        <li>FC x 816 (+ 816)</li>
                        <li>FC x 2 040 (+ 2 040)</li>
                        <li>FC x 4 180 (+ 4 180)</li>
                    </ul>
                </div>
                <div class="card-form">
