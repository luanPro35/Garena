...
<main>
    <div class="container">
        <div class="nap-so-container">
            <h1>Nạp Sò</h1>
            <div class="alert">
                <p>Nạp Sò Garena nhận ngay phần quà ngẫu nhiên 2000-4000 Sò khi nạp thẻ lần đầu trong ngày với thẻ có mệnh giá từ 500.000đ trở lên.</p>
            ...
            <div class="card-details">
                ...
                <div class="points-list">
                    ...
                    <ul>
                        ...
                        <li>Sò x 400 (+ 400)</li>
                        <li>Sò x 800 (+ 800)</li>
                        <li>Sò x 2 000 (+ 2 000)</li>
                        <li>Sò x 4 000 (+ 4 000)</li>
                    </ul>
                </div>
                <div class="card-form">
